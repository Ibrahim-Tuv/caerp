...
class HREndServiceBenifits(models.Model):
    ...
    state = fields.Selection(string="State", track_visibility='onchange',
    ...
    date = fields.Date(string="Date", default=datetime.now().strftime('%Y-%m-%d'), track_visibility='onchange',
                       copy=False)
